...
legend('B_E + R_E', 'B_P + I_E', 'B_E', 'B_L', 'B_P', 'B_A', 'R_E', 'R_A', 'FontSize', 12)
xlabel('Time (Days)')
ylabel('Amount')
...
legend('B_P + I_E', 'B_P', 'B_A', 'R_E', 'R_A', 'I_E', 'I_A', 'FontSize', 12)
xlabel('Time (Days)')
ylabel('Amount')
